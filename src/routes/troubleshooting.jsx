  ...
  return (
    <div className='subpage-container troubleshooting'>
      <header>
        ...
        <h4>
          Patrons have access to <strong>priority help</strong> with my modules.
        </h4>
        <p>
          If you are a patron, please follow Steps 1, 2 and 3 then get back to
          me in #troubleshooting on Discord with the information from these
          steps and I'll assist you.
        </p>
      </header>
      <div className='troubleshooting-wrapper noselect'>
        {troubleshootingData.map(
          (data, index) =>
            index < 5 && (
              <TroubleshootingCard
                key={index}
                ...
                setTroubleshootingData={setTroubleshootingData}
              />
            )
        )}
        <div className='step6'>
