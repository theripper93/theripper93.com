            ...
            <article className='card-solid free-border'>
              <details>
                ...
                <ol>
                  ...
                  <li>
                    In the top "Filter Packages" searchbar type the name of the
            ...
            <article className='card-solid free-border'>
              <details>
                ...
                <ol>
                  ...
                  <li>Click the "Install Module" button</li>
                  <li>
                    In the bottom input field "Manifest URL" paste the Manifest
                    URL
                  </li>
                  <li>
                    Click the "Install" button in the bottom right, to the left
                    of where you pasted the Manifest URL
                  </li>
                  <li>
                    You can now enable the module inside your worlds. If you
                    need to update you can do so through the "Add-on Modules"
                    tab.
                  </li>
                </ol>
              </details>
            ...
            <article className='card-solid paid-border'>
              <details>
                ...
                <ol>
                  ...
                  <li>
                    Unzip the file and locate the folder without the module
                    version in it's name
                  </li>
                  <li>
                    For example if you are installing Filepicker+ 0.9.5 you will
                    need to locate the folder named "filepicker-plus", depending
                    on how you extracted the file this folder might be located
                  ...
                  <li>
                    Navigate to your Foundry VTT User Data. If you don't know
                    how to locate it, you can right click the Foundry VTT icon
                    in the windows taskbar while the application is running and
                    click "Browse User Data"
                  </li>
                  ...
                  <li>
                    You can now enable the module inside your worlds. If you
                    need to update simply paste the new version over the old one
            ...
            <article className='card-solid paid-border'>
              <details>
                ...
                <ol>
                  ...
                  <li>
                    On the Top Navigation Bar in The Forge homepage, hover over
                    "My Foundry" and click "Games Configuration"
                  </li>
                  <li>Click the "Summon Import Wizard" button</li>
                  <li>Select the "ZIP File" option</li>
                  <li>
                    Click the "Browse" button and locate the ZIP file you
                  ...
                  <li>
                    You can now enable the module inside your worlds. If you
                    need to update simply repeat this procedure.
                  </li>
                </ol>
              </details>
            </article>
