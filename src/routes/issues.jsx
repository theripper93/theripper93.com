...
export default function BugReport() {
  ...
  return (
    <div className='subpage-container issues'>
      ...
      {issues.map(
        (issue, index) =>
          index < issues.length - 1 && <IssueCard key={index} issue={issue} />
      )}
      <IssueCard issue={bugReport}>
        <ol>
          <li>
            <input
              onChange={updateIssueTemplate}
              type='checkbox'
              name='disabled'
              id=''
              defaultChecked={bugReport?.description[0].placeholder}
            />
            <label>{bugReport?.description[0].title}</label>
          </li>
          <li>
            <label>{bugReport?.description[1].title}</label>
            <br></br>
            <input
              onChange={updateIssueTemplate}
              type='text'
              name='modules'
              id=''
              placeholder={bugReport?.description[1].placeholder}
            />
          </li>
          <li>
            ...
            <input
              ...
              name='conflicts'
              id=''
              placeholder={bugReport?.description[2].placeholder}
            />
          </li>
          <li>
            ...
            <input
              ...
              name='versions'
              id=''
              placeholder={bugReport?.description[3].placeholder}
            />
          </li>
          <li>
            ...
            <input
              ...
              name='platforms'
              id=''
              placeholder={bugReport?.description[4].placeholder}
            />
          </li>
          <li>
            ...
            <input
              ...
              name='description'
              id=''
              placeholder={bugReport?.description[5].placeholder}
            />
          </li>
          <li>
            <label>{bugReport?.description[6].title}</label>
            <br></br>
            <textarea
              onChange={updateIssueTemplate}
              rows='5'
              name='steps'
              id=''
              placeholder={bugReport?.description[6].placeholder}
            />
          </li>
          <li>
            <input
              ...
              name='screenshots'
              id=''
              defaultChecked={bugReport?.description[7].placeholder}
            />
        ...
        <footer className='issues footer'>
          <button
            ...
            disabled={!issueTemplate.disabled || !issueTemplate.screenshots}
          >
            Copy to Clipboard
          </button>
          {(!issueTemplate.disabled || !issueTemplate.screenshots) && (
            <p className='paid'>{bugReport?.footer}</p>
          )}
        </footer>
      </IssueCard>
    </div>
